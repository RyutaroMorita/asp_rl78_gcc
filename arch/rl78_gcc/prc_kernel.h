 ...
 *  最小値 TMIN_INTPRI に設定可能な値の範囲は，-3, -2, -1 である．
 *
 *  例えば TMIN_INTPRI を -2 に設定すると，NMI に加え割込み優先度が
 *  -4 及び -3 に設定されている割込み要求ラインからの割込みが
 *  カーネル管理外の割込みとなる．
 *  また，TMIN_INTPRI を -4 に設定することはできず，NMI および -4 は常に
 *  カーネル管理外の割込みとなる．
 */
#ifndef TMIN_INTPRI
